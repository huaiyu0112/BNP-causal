# BNP-causal
R Codes for simulations and data analysis in Zang et.al. (2021+) "A Bayesian Causal Inference Approach in Observational Studies with Missingness in Covariates and Outcomes".
