...
dir.create("5_MICE_Off_Shelf_Est_MAR")
...
for (i_rep in rep_seq){
  ...
  save(true.mi, q.mi, se.mi, check.mi, file = paste("5_MICE_Off_Shelf_Est_MAR/res_", i_rep , "_mice_causal_multiimp",".RData", sep = ""))
} # for (i_rep)
...
for (i_rep in rep_seq) {
  ...
  # i_rep = 1
  load(paste("5_MICE_Off_Shelf_Est_MAR/res_", i_rep, "_mice_causal_multiimp",".RData", sep = ""))
...
write.csv(causal_res_Y, file = "5_MICE_Off_Shelf_Est_ATE_Y.csv")
...
write.csv(causal_res_X, file = "5_MICE_Off_Shelf_Est_ATE_X.csv")
