...
for (i_rep in rep_seq) {
  ...
  save(ATE_BNPc, SD_ATE_BNPc, Check_ATE_BNPc, true.mi, q.mi, se.mi, check.mi, file = paste0("4_BNPc_MAR/Result_", i_rep,".RData"))
...
write.csv(BNPc_res, file = "4_BNPc_MAR_causal.csv")
...
imp_res = data.frame(Method = "BNPc", Est= effect_imp, point= est_imp, Emp_sd = emp_sd_imp, RMSE = RMSE_imp, Coverage = coverage_imp, Avg_sd = avg_sd_imp)
