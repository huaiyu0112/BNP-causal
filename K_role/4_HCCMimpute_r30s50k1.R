...
save(mu_L3_rep, mu_L4_rep, se_mu_L3_rep, se_mu_L4_rep, IsCovered_mu_L3_rep, IsCovered_mu_L4_rep, file = "HCCMimpute_r30s50k1.Rdata")
...
write.csv(imp_res, file = "HCMM_imputation_r30s50k1.csv")

save.image(file = "HCMM_impute_all_r30s50k1.RData")
...
for (which_imp in seq ){
  ...
  png(file=paste0("check_r30s50k1/Bivariate_plot",which_imp,".png"), width=1200,height=800,pointsize=20)
  ...
  # which_imp = 1
  par(mfrow=c(1,1))
  png(file=paste0("check_r30s50k1/Barplot",which_imp,".png"), width=1200,height=800,pointsize=20)
...
png(file=paste0("check_r30s50k1/traceplot_k_s_r.png"), width=1200,height=800,pointsize=20)
par(mfrow=c(1,1))
