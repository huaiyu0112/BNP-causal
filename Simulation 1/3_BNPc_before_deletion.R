...
HCMM_causal_res = data.frame(Method = method, Effect = effect, Bias = bias_ATE_HCMM, Emp_sd = emp_sd_ATE_HCMM, Avg_sd= ave_sd_ATE_HCMM, 
                             RMSE = RMSE_ATE_HCMM, MAE= MAE_ATE_HCMM, Coverage= coverage_ATE_HCMM)

write.csv(HCMM_causal_res, file = "2_BNPc_BD.csv")
