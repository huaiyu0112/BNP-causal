...
Y_missing_ind = rbinom(n_sample, 1, expit_fn(1 + 2.5*ifelse(L1_7[,5]==1, 1, 0) - 0.5*L1_7[,7]))
X_missing_ind = rbinom(n_sample, 1, expit_fn(2 + 4*ifelse(L1_7[,5]==1, 1, 0) - 1.5*L1_7[,7]))
L1_missing_ind = rbinom(n_sample, 1, expit_fn(-2.5 - 1.5*ifelse(L1_7[,5]==1, 1, 0) + 0.5*L1_7[,7]))
L6_missing_ind = rbinom(n_sample, 1, expit_fn(1 + 0.5*ifelse(L1_7[,5]==1, 1, 0) - 1.5*L1_7[,7]))
